...
class TbsGridPanel30 extends TbsGridPanelBase {
    ...
    setDataPanel1(param) {
        ...
        for (let i = topRowIndex; i < bottomRowIndex + 1; i++) {
            ...
            let selectedValue = grid.tbs_isSelectedCell(panelName, i, 0);
            ...
            if (grid.options[grid.option_rowMode] ) {
            ...
            if (grid.options[grid.option_checkbox]) {
    ...
    setDataPanel0(param) {
        ...
        if (panelName == 'panel30') {
            ...
            if (grid.grid_mode == grid.code_page || grid.grid_mode == grid.code_pagination) rowCount = grid.data_page.length;
            else if (grid.grid_mode == grid.code_page || grid.grid_mode == grid.code_pagination) rowCount = '';
            else rowCount = grid.tbs_getRowCount();
