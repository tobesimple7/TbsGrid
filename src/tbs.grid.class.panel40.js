...
class TbsGridPanel40 extends TbsGridPanelBase {
    ...
    setDataPanel() {
        ...
        this.setDataPanel2({panelName: 'panel41', summaryColumns: grid.topColumns });
        this.setDataPanel1({panelName: 'panel40', summaryColumns: grid.topColumns });
        this.setDataPanel0({panelName: 'panel42', summaryColumns: grid.topColumns });
    }
    setDataPanel1() {
        let selector = this.selector;
        let grid = this.grid;
