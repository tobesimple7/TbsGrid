...
export class TbsGridBaseEvent {
    ...
    input_show(this: TbsGrid, e, mode) { //type : header, content, left, top
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    input_focus(this: TbsGrid) { if (this.isMobile == false) (document.querySelector('#' + this.gridId + ' .tbs-grid-input') as any).focus(); }

    editStart(this: TbsGrid, e, mode) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    event_columnSort(this: TbsGrid, cell) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    event_mobileTouchDrag(this: TbsGrid) { //type : header, content
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    event_columnResize(this: TbsGrid, panelName) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    event_wheel(this: TbsGrid) { //mouse wheel event
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    event_scrollButton(this: TbsGrid) {
        //mouse wheel event
    ...
    event_dragScrollBar(this: TbsGrid) {
    ...
    tbs_moveCellLine(this: TbsGrid, cell, rowIndex, cellIndex) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    isMovedPositionInConstRange(this: TbsGrid, startX, startY, lastX, lastY) {
    ...
    tbs_getMaxRowIndexByMouseMove(this: TbsGrid) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMinRowIndexByMouseMove(this: TbsGrid) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMaxCellIndexByMouseMove(this: TbsGrid) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMinCellIndexByMouseMove(this: TbsGrid) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMaxRowIndexByMouseMove2(this: TbsGrid, panelName) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMinRowIndexByMouseMove2(this: TbsGrid, panelName) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMaxCellIndexByMouseMove2(this: TbsGrid, panelName) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_getMinCellIndexByMouseMove2(this: TbsGrid, panelName) {
        let selector = '#' + this.gridId;
        const grid = this;
    ...
    tbs_moveNextRowCell(this: TbsGrid, type) {
    ...
    tbs_moveCell(this: TbsGrid, type) { //type : left, right, up, down
        let selector = '#' + this.gridId;
        const grid = this;
