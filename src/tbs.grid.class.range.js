class TbsGridRange {
    ...
    selectRange = function (startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex) {
        ...
        if (lastRowIndex  == -1) { lastRowIndex  = grid.data_view.length - 1; }
        ...
        if (grid.topColumns.length > 0) grid.classRange40.removeRange(0, -1, 0, -1);
        if (grid.footerColumns.length > 0) grid.classRange50.removeRange(0, -1, 0, -1);
    ...
    setRange = function (startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex, type = 'add') {
        ...
        if (grid.fixedRowIndex == -1) {
            topRowIndex = (topRowIndex == undefined) ? grid.tbs_getFirstRowIndex() : grid.fixedRowIndex + 1;
        }
        else {
