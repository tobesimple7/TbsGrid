...
export class TbsGridPanel40 extends TbsGridPanelBase {
    ...
    setDataPanel() {
        ...
        this.setDataPanel2({panelName: 'panel41', summaryColumns: grid.top_column_table.data });
        this.setDataPanel1({panelName: 'panel40', summaryColumns: grid.top_column_table.data });
        this.setDataPanel0({panelName: 'panel42', summaryColumns: grid.top_column_table.data });
    }
        ...
        const selectCellMove = function(e) {
            ...
            if (grid.fixedColumnIndex != -1) {
                ...
                if (lastX < panelLeft || lastX > panelRight) {
                    ...
                    else if (lastX > panelRight ) { flagRight = true; doInterval(tbsGridTypes.Direction.right); }
                }
                select(moveX, moveY);
            }
            else {
