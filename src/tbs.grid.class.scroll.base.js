class TbsGridScrollBase {
    ...
    setPanelSize() {
        ...
        if (grid.footerColumns.length > 0) {
    ...
    setBarPositionByDirection(type, rowIndex) {
        ...
        if (type == 'up') {
            let displayTopRowIndex = grid.tbs_getFirstDisplayRowIndex();
            let trTopIndex = grid.tbs_getFirstRowIndex() - 1;
        ...
        if (type == 'down') {
            let displayTopRowIndex = grid.tbs_getFirstDisplayRowIndex();
            let trTopIndex = 0;
            if (rowIndex == undefined) trTopIndex = grid.tbs_getFirstRowIndex() + 1;
