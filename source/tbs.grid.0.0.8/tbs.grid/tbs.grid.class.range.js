...
TbsGridRange.prototype.class_selectRange = function (startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex) {
    ...
    if (panelName == 'panel40') grid.classRange50.class_removeRange(0, -1, 0, -1);
    else if (panelName == 'panel50') grid.classRange40.class_removeRange(0, -1, 0, -1);

    classRange.class_setRange(startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex, '');
}
TbsGridRange.prototype.class_setRange = function (startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex, type = 'add') {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
    let panelName = this.panelName;
    ...
    classRange.class_setRangeValue(_startRowIndex, _lastRowIndex, _startCellIndex, _lastCellIndex);
...
TbsGridRange.prototype.class_removeRange = function (startRowIndex, lastRowIndex, startCellIndex, lastCellIndex) {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
    let panelName = this.panelName;
...
TbsGridRange.prototype.class_addRange = function (startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex) {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
    let panelName = this.panelName;
    ...
    if (lastCellIndex == -1) { lastCellIndex = grid.columns.length - 1;   }
    classRange.class_setRange(startRowIndex, lastRowIndex, startCellIndex, lastCellIndex, topRowIndex, 'add');
}
TbsGridRange.prototype.class_getMaxCellIndexByMouseMove = function() {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
    let panelName = this.panelName;
    ...
    const rowIndexArray = [];
    if (grid.fixedColumnIndex != -1) {
        num = classRange.class_getMaxCellIndexByMouseMove2(panelName2); if (num != undefined) rowIndexArray.push(num);
        num = classRange.class_getMaxCellIndexByMouseMove2(panelName0); if (num != undefined) rowIndexArray.push(num);
        maxCellIndex = Math.max(...rowIndexArray);
    } else {
        maxCellIndex = classRange.class_getMaxCellIndexByMouseMove2(panelName0);
    }
    return maxCellIndex;
}
TbsGridRange.prototype.class_getMinCellIndexByMouseMove = function() {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
    let panelName = this.panelName;
    ...
    if (grid.fixedRowIndex != -1 && grid.fixedColumnIndex != -1) {
        num = classRange.class_getMinCellIndexByMouseMove2(panelName2); if (num != undefined) rowIndexArray.push(num);
        num = classRange.class_getMinCellIndexByMouseMove2(panelName0); if (num != undefined) rowIndexArray.push(num);
        ...
        minCellIndex = classRange.class_getMinCellIndexByMouseMove2(panelName0);
    }
    return minCellIndex;
}
TbsGridRange.prototype.class_getMaxCellIndexByMouseMove2 = function(panelName) {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
...
TbsGridRange.prototype.class_getMinCellIndexByMouseMove2 = function(panelName) {
    let selector = this.selector;
    let grid = this.grid;
    let classRange = this;
