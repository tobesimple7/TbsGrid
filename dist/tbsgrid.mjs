...
/* harmony import */ var _tbs_base_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(801);
/* harmony import */ var _tbs_grid_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(180);
/* harmony import */ var _tbs_grid_render_info_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(932);
...
/* harmony import */ var _tbs_grid_render_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(180);
/* harmony import */ var _tbs_grid_render_info_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(932);
  ...
  panel10_select() {
    ...
    const showGroupPanelEvent = function (e) {
      ...
      if (grid.grid_mode != tbsGridTypes.GridMode.group) {
        ...
        if (grid.options[grid.option_showGroupPanel] == true) grid.classGroup.denyGroupMode();else grid.classGroup.allowGroupMode();
      }
    };
  ...
  panel20_select(panelName) {
    ...
    const mouseUpEvent = function (e) {
      ...
      if (isInPanel80) {
        ...
        if (mouseButton == 0 && startX > lastX - grid.grid_mousePointRange && startX < lastX + grid.grid_mousePointRange && startY > lastY - grid.grid_mousePointRange && startY < lastY + grid.grid_mousePointRange) {
...
class TbsGridPanel50 extends _tbs_grid_panel_base_js__WEBPACK_IMPORTED_MODULE_1__/* .TbsGridPanelBase */ .B {
  ...
  setDataPanel2() {
    ...
    // on fixed columns
    const tbsGridCell = new grid.classCell.hideTableCells(grid, panelName, tableRow, lastColumnIndex);
  }
  setDataPanel0() {
    let selector = this.selector;
    let grid = this.grid;
...
class TbsGridPanel90 extends _tbs_grid_panel_base_js__WEBPACK_IMPORTED_MODULE_1__/* .TbsGridPanelBase */ .B {
  ...
  createHtml(parentElement) {
    let grid = this.grid;
    let s = '';
    if (grid.options[grid.option_showSortPanel] == true) s += '<div class="tbs-grid-panel90 tbs-grid-show"></div>';else s += '<div class="tbs-grid-panel90 tbs-grid-hide"></div>';
    parentElement.insertAdjacentHTML('beforeend', s);
...
/* harmony import */ var _tbs_grid_types_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(447);
/* harmony import */ var _tbs_base_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(801);
...
/* harmony export */ });
/* harmony import */ var _tbs_base_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(801);
/* harmony import */ var _tbs_data_table_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(690);
...
/* harmony export */ });
/* harmony import */ var _tbs_grid_types_js__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(447);
/* harmony import */ var _tbs_base_js__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(801);
/* harmony import */ var _tbs_database_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(182);
/* harmony import */ var _tbs_data_table_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(690);
/* harmony import */ var _tbs_grid_cell_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(380);
/* harmony import */ var _tbs_grid_columns_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
/* harmony import */ var _tbs_grid_combo_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(288);
/* harmony import */ var _tbs_grid_control_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(499);
/* harmony import */ var _tbs_grid_date_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(500);
/* harmony import */ var _tbs_grid_dom_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(122);
/* harmony import */ var _tbs_grid_row_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(730);
/* harmony import */ var _tbs_grid_filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(918);
/* harmony import */ var _tbs_grid_filter_layer_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(205);
/* harmony import */ var _tbs_grid_footer_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(599);
/* harmony import */ var _tbs_grid_group_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(101);
/* harmony import */ var _tbs_grid_page_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(735);
/* harmony import */ var _panels_tbs_grid_panel_base_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(445);
/* harmony import */ var _panels_tbs_grid_panel10_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(69);
/* harmony import */ var _panels_tbs_grid_panel20_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(314);
/* harmony import */ var _panels_tbs_grid_panel30_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(543);
/* harmony import */ var _panels_tbs_grid_panel40_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(876);
/* harmony import */ var _panels_tbs_grid_panel50_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(705);
/* harmony import */ var _panels_tbs_grid_panel70_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(427);
/* harmony import */ var _panels_tbs_grid_panel80_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(488);
/* harmony import */ var _panels_tbs_grid_panel90_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(677);
/* harmony import */ var _tbs_grid_range_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(239);
/* harmony import */ var _tbs_grid_range_panel_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(959);
/* harmony import */ var _tbs_grid_render_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(180);
/* harmony import */ var _tbs_grid_render_info_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(932);
/* harmony import */ var _tbs_grid_scroll_base_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(226);
/* harmony import */ var _tbs_grid_scroll_js__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(581);
/* harmony import */ var _tbs_grid_sort_js__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(168);
/* harmony import */ var _tbs_grid_top_js__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(925);
/* harmony import */ var _tbs_grid_tree_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(836);
...
class TbsGridRenderInfo {
  ...
  createHtml() {
    ...
    if (this.columnType == tbsGridTypes.CellType.checkbox) {
      ...
      if (render.tableCell.querySelectorAll('.tbs-grid-cell-checkbox').length == 0) render.tableCell.childNodes[0].append(element);
    } else {
      let element = grid.classDom.createElementCellText();
      if (render.tableCell.querySelectorAll('.tbs-grid-cell-div-text').length == 0) render.tableCell.childNodes[0].append(element);
    }
    render.setBounding();
  }
  setBounding() {
...
class TbsGridRender {
  ...
  setBounding() {
    ...
    grid.classDom.setCellStyle(render.tableCell, 'textAlign', render.align); // user event
    grid.classDom.setCellStyle(render.tableCell, 'width', render.width + 'px');
    if (render.panelName == 'panel72' || render.panelName == 'panel70') {} else {
    ...
    if (grid.user_cellBounding) {
      if (render.panelName.substring(6) == '0' || render.panelName.substring(6) == '2') {
        let param = {
          element: render.tableCell,
          rowIndex: render.rowIndex,
          cellIndex: render.columnIndex
        };
  ...
  setTreeIcon(tableCell, rowIndex) {
    ...
    if (arrayChildren.length > 0) {
      ...
      if (grid.null(nextRow)) grid.classTree.toggleTreeIcon(rowIndex, element, 'closed');else {
        if (nextRow[grid.classTree.options[tbsGridNames.tree.parentName]] == row[grid.classTree.options['itemName']]) grid.classTree.toggleTreeIcon(rowIndex, element, 'open');else grid.classTree.toggleTreeIcon(rowIndex, element, 'closed');
      }
...
class TbsGrid extends _tbs_grid_base_js__WEBPACK_IMPORTED_MODULE_1__/* .TbsGridBase */ .R {
  ...
  setTreeOption(optionName, optionValue) {
    this.classTree.setTreeOption(optionName, optionValue);
  }
  ...
  createTableHead(panelName, table) {
    ...
    if (s == '1') grid.createTableHead1(panelName, table);else if (s == '2') grid.createTableHead2(panelName, table);else grid.createTableHead0(panelName, table);
  }
  ...
  getConfigOption(label) {
    return this.null(this.gridConfig.options[label]) ? 'No Label' : this.gridConfig.options[label];
  }
